...
# Setup UDP client
def setup_udp_client():
    UDP_IP = "192.168.4.1"  # ESP8266'nın IP adresi
    UDP_PORT = 5005  # ESP8266'nın portu
...
# Send message
def send_udp_message(sock, addr, message):
    sock.sendto(message.encode(), addr)

sock, addr = setup_udp_client()
...
DODGE_THRESHOLD = 120  # Minimum distance required to dodge in cm
                ...
                if 40 < distance < 300 and avg_distance_change < -0.8 and distance <= DODGE_THRESHOLD:
                    ...
                    if dodge_signals_sum > 0 and dodge_signal_counter == 7:
                        ...
                        if main_signal != last_signal:
                            ...
                            send_udp_message(sock, addr, main_signal)  # Her döngüde çağırılır
